<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage.Master" AutoEventWireup="true" CodeBehind="checkout.aspx.cs" Inherits="Clinic_Management_System.checkout" %>
	...
	<div class="content-wrapper">
          <div class="content">					<div class="invoice-wrapper rounded border bg-white py-5 px-3 px-md-4 px-lg-5">
						...
						<div class="row pt-5">
							...
							<div class="col-xl-3 col-lg-4">
								<p class="text-dark mb-2 font-weight-bold">Details</p>
								<address>
									Order Date:
									<br> <asp:Label ID="Date" runat="server" Text="Label"></asp:Label>
						...
						<div class="row justify-content-end">
							<div class="col-lg-5 col-xl-4 col-xl-3 ml-sm-auto">
								<ul class="list-unstyled mt-4">
									...
									<li class="pb-3 text-dark font-weight-bold pb-2 fa-font-3x">Grand Total:
										<asp:Label ID="gtotal" class="d-inline-block float-right" runat="server" Text="Label"></asp:Label>
									</li>
								</ul>

			  
    
                                <asp:Button ID="PlaceOrder" OnClick="PlaceOrder_Click" class="btn btn-block mt-2 btn-lg btn-primary btn-pill" style="background-color:#B0B435;border-color:#B0B435" runat="server" Text="Place Order" />
