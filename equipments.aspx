<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage.Master" AutoEventWireup="true" CodeBehind="equipments.aspx.cs" Inherits="Clinic_Management_System.equipments" %>
                                            ...
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <div class="mask-icon">
                                                        ...
                                                        <a class="cart"><asp:Button ID="addCart" CommandArgument='<%#Eval("machineID") %>' CommandName="machinecart" runat="server" BackColor="#B0B435" BorderStyle="None" Text="Add to Cart" /></a>
                                                    </div>
                                                </div>
                                                <div class="why-text">
                                                    <p class="available-stock"><span> <%#Eval("machineQuantity")%> / <a style=" font-weight:800" href="#">8 sold </a></span><p>
                                                        <h4> <%#Eval("machineName")%></h4>
                                                        <h5> Rs <%#Eval("machinePrice")%></h5>
                                                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                                     <asp:Button ID="Button1" BackColor="#B0B435" CommandArgument='<%#Eval("machineID") %>' CommandName="machineID" BorderStyle="None" ForeColor="White" Font-Bold="true" Height="28px" runat="server" Text="View Detail" />
                                                </div>
                                            </div>
                                        </div>
